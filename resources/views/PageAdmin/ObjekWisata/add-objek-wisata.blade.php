          ...
          <div class="col-md-12">
            <div class="card card-outline card-primary">
              <div class="card-header">
                <h2 class="card-title">Add Data Objek Wisata</h2>
                <!-- /.card-tools -->
              </div>
              <!-- /.card-header -->
              <form action="{{ route('insert-objek-wisata') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Objek Wisata" name="objekwisata">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="posisi" placeholder="Latitude, Longitude" name="posisi" readonly>
                        <div class="text-danger">
                          @error('posisi')
                            {{ $message }}
                          @enderror
