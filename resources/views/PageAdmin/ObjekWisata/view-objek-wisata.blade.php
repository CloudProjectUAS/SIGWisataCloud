          ...
          <div class="col-md-12">
            <div class="card card-outline card-primary">
              <div class="card-header">
                <h2 class="card-title">Data Objek Wisata</h2>

                <div class="card-tools">
                  <a href="{{ route('add-objek-wisata') }}" type="button" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i>
                  Tambah</a>
                </div>
                <!-- /.card-tools -->
              </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-danger">
      <div class="modal-header">
        <h4 class="modal-title">{{ $data->objek_wisata }}</h4>
      ...
      <div class="modal-footer justify-content-between">
        ...
        <a href="/ObjekWisata/Delete/{{ $data->id }}" type="button" class="btn btn-outline-light">Yes</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
