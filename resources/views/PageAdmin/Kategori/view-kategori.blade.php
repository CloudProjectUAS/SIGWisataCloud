            ...
            <div class="card card-outline card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="{{ route('add-kategori') }}" type="button" class="btn btn-primary btn-flat"><i class="fa fa-plus"></i>
                  Tambah</a>
                </div>
                <!-- /.card-tools -->
              </div>
                  ...
                  <tbody>
                    ...
                    @foreach ($kategori as $data)
                      <tr>
                        ...
                        <td>{{ $data->kategori }}</td>
                        <td class="text-center"><img src="{{asset('Icons')}}/{{ $data->icon }}" width="60px"></td>
